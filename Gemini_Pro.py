...
with centered_content()[1]:
    st.title(":blue[G]:red[e]:green[m]:blue[i]:green[n]:red[i] :blue[P]:red[o]:green[w]:blue[e]:green[r]:red[e]:blue[d] :blue[A]:red[I] :red[C]:green[h]:blue[a]:green[t]:red[b]:blue[o]:green[t]")
